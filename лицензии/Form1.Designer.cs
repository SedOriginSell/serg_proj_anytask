namespace лицензии
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Size = new System.Drawing.Size(587, 50);
			this.button1.TabIndex = 0;
			this.button1.Text = "ПРИВАТНЫЙ/ПУБЛИЧНЫЙ КЛЮЧ";
			...
			this.label1.Text = "когда закончится лицензия";
			// 
			// label2
			// 
			this.label2.AutoSize = true;
			this.label2.Location = new System.Drawing.Point(234, 195);
			this.label2.Name = "label2";
			this.label2.Size = new System.Drawing.Size(166, 13);
			this.label2.TabIndex = 6;
			this.label2.Text = "фичи лицензии (через запятую)";
			// 
			// label3
			// 
